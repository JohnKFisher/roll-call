...
Roll Call 1.2.2 and 1.2.3 contain miscellaneous bug fixes and reliability improvements, including safer cancellation and cleanup while generating local song clips.
